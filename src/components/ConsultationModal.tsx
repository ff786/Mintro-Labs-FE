      ...
      >
        <div className="flex min-h-full items-center justify-center p-4 sm:p-6">
          <div
              ...
              className="flex w-full max-w-3xl max-h-[90dvh] flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-950 text-white shadow-[0_30px_120px_rgba(0,0,0,.65)]"
          >
            {/* HEADER */}
            <div className="flex items-start justify-between gap-4 border-b border-white/10 bg-zinc-950 px-6 py-5 sm:px-8 flex-shrink-0">
              <div>
                ...
                <p className="mt-2 max-w-xl text-sm leading-6 text-white/60">
                  Fill out the form below and we'll open WhatsApp with your
                  project details already prepared.
                </p>
              </div>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <span className="text-sm font-medium text-white/80">
                  ...
                  <textarea
                      ...
                      className="min-h-[150px] w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white outline-none transition focus:border-sky/60"
                  />
                </label>
              </div>

              {/* FOOTER */}
              <div className="sticky bottom-0 mt-8 border-t border-white/10 bg-zinc-950 pt-5 pb-[calc(env(safe-area-inset-bottom)+12px)]">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <p className="text-sm text-white/50">
                    We'll send everything directly to WhatsApp.
                  </p>
